...
public class RabinFrame extends JInternalFrame implements InternalFrameListener{
    private Rabin rabin=new Rabin();
    private boolean reczna_edycja_klucza=false;
    private BigInteger szyfrogram[];
    private BigInteger deszyfrogram[],deszyfrogram1[],deszyfrogram2[],deszyfrogram3[],deszyfrogram4[];
    ...
    class RabinSecFilter extends javax.swing.filechooser.FileFilter 
    {
        
        String ext;
        
        public RabinSecFilter ()
        {
            ext=".rabinSecKey";
        }
        ...
        {
            return "Plik klucza prywatnego algorytmu Rabina";
        }
    }
     class RabinPubFilter extends javax.swing.filechooser.FileFilter 
     {
        
        String ext;
        
        public RabinPubFilter ()
        {
            ext=".rsaPubKey";
        }
        ...
        public String getDescription()
        {
            return "Plik klucza publicznego algorytmu Rabina";
        }
    }
    ...
    public RabinFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) 
    {
       super(title, resizable, closable, maximizable, iconifiable);
        ...
        initComponents();
        jTextField3.setText(rabin.p.toString(16));
        jTextField8.setText(rabin.q.toString(16));
        jTextField9.setText(rabin.N.toString(16));
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Klucz Prywatny p");
        ...
        jLabel9.setText("Klucz Prywatny q");

        jLabel10.setText("Klucz Publiczny N");
    ...
    private void szyfrujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_szyfrujActionPerformed
       ...
       * ustawiamy w klasie e,d,n*/
        try{
            ...
            {
                if(jTextField3.getText().length()<rabin.ilZnHex)throw rabin.new RabinKeyException("Podana wartość p jest za krótka.\nWynosi "+ jTextField3.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex+" znaki w systemie szesnastkowym.");
                if(jTextField3.getText().length()>rabin.ilZnHex)throw rabin.new RabinKeyException("Podana wartość p jest za długa.\nWynosi "+ jTextField3.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex+" znaki w systemie szesnastkowym.");
                if(jTextField8.getText().length()<rabin.ilZnHex)throw rabin.new RabinKeyException("Podana wartość q jest za krótka.\nWynosi "+ jTextField8.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex+" znaki w systemie szesnastkowym.");
                if(jTextField8.getText().length()>rabin.ilZnHex)throw rabin.new RabinKeyException("Podana wartość q jest za długa.\nWynosi "+ jTextField8.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex+" znaki w systemie szesnastkowym.");
                if(jTextField9.getText().length()<rabin.ilZnHex*2)throw rabin.new RabinKeyException("Podana wartość N jest za krótka.\nWynosi "+ jTextField9.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex*2+" znaki w systemie szesnastkowym.");
                if(jTextField9.getText().length()>rabin.ilZnHex*2)throw rabin.new RabinKeyException("Podana wartość N jest za długa.\nWynosi "+ jTextField9.getText().length()+" .\nMusi wynosić "+ rabin.ilZnHex*2+" znaki w systemie szesnastkowym.");

                rabin.p= new BigInteger(jTextField3.getText(),16);
                rabin.q= new BigInteger(jTextField8.getText(),16);
                rabin.N= rabin.p.multiply(rabin.q);
                BigInteger N=new BigInteger(jTextField9.getText(),16);
                if (!rabin.N.equals(N))
                    {JOptionPane.showMessageDialog(null, "Wartość N nie zgadza się z wartościami p oraz q!\nzostała obliczona poprawna wartość N.", "Problem z kluczem publicznym", JOptionPane.ERROR_MESSAGE);
                    jTextField9.setText(rabin.N.toString(16));
                    }
             ...
             {  if(tekstJawny!=null)szyfrogram=rabin.encrypt(tekstJawny);
             ...
             else jTextArea2.setText(Auxx.bytesToHex(rabin.encryptFromStringToString(jTextArea1.getText()).getBytes())); 
             
           } catch(Rabin.RabinKeyException e){JOptionPane.showMessageDialog(null, e.getMessage(), "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
    ...
    private void wczytaj_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wczytaj_kluczActionPerformed
     try{
        ...
        fch.setFileFilter(new RabinSecFilter()); 
        int wybor =fch.showOpenDialog(this);
        if (wybor == JFileChooser.APPROVE_OPTION) 
        {   String pom=fch.getSelectedFile().getPath();
        ...
        fch.setFileFilter(new RabinPubFilter()); 
    ...
    {   String pom=fch.getSelectedFile().getPath();
        ...
        try{ 
                if(jRadioButton1.isSelected())//plik
                {if(deszyfrogram.length>0)
                {String pom1=pom.substring(0, pom.lastIndexOf('.'))+"1."+pom.substring(pom.lastIndexOf('.')+1,pom.length());
                 Auxx.zapiszDoPlikuTabliceBigInt(deszyfrogram1, pom1);
                 String pom2=pom.substring(0, pom.lastIndexOf('.'))+"2."+pom.substring(pom.lastIndexOf('.')+1,pom.length());
                 Auxx.zapiszDoPlikuTabliceBigInt(deszyfrogram2, pom2);
                 String pom3=pom.substring(0, pom.lastIndexOf('.'))+"3."+pom.substring(pom.lastIndexOf('.')+1,pom.length());
                 Auxx.zapiszDoPlikuTabliceBigInt(deszyfrogram3, pom3);
                 String pom4=pom.substring(0, pom.lastIndexOf('.'))+"4."+pom.substring(pom.lastIndexOf('.')+1,pom.length());
                 Auxx.zapiszDoPlikuTabliceBigInt(deszyfrogram4, pom4);
                };}
                //else if(tekstJawny.length>0) Pomocnicza.zapiszDoPliku(tekstJawny, pom);
    ...
    private void deszyfrujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deszyfrujActionPerformed
      try{
            if(reczna_edycja_klucza)
            {
             ...
             if(jRadioButton1.isSelected())//plik
             {deszyfrogram=rabin.decryptToBigInt(szyfrogram);
             int len=(int)deszyfrogram.length/4;
             deszyfrogram1=new BigInteger[len];
             deszyfrogram2=new BigInteger[len];
             deszyfrogram3=new BigInteger[len];
             deszyfrogram4=new BigInteger[len];
             
             for (int i=0,j=0;i<len;i++,j+=4)
             {deszyfrogram1[i]=deszyfrogram[j];
              deszyfrogram2[i]=deszyfrogram[j+1];
              deszyfrogram3[i]=deszyfrogram[j+2];
              deszyfrogram4[i]=deszyfrogram[j+3];
             
             }
              String wynik="";
              for(int i=0;i<len;i++)wynik+=Auxx.bigIntToString(deszyfrogram1[i]);wynik+="\n========================================\n";
              for(int i=0;i<len;i++)wynik+=Auxx.bigIntToString(deszyfrogram2[i]);wynik+="\n========================================\n";
              for(int i=0;i<len;i++)wynik+=Auxx.bigIntToString(deszyfrogram3[i]);wynik+="\n========================================\n";
              for(int i=0;i<len;i++)wynik+=Auxx.bigIntToString(deszyfrogram4[i]);
             ...
             {String spom=new String(Auxx.hexToBytes(jTextArea2.getText()));
                     jTextArea1.setText(rabin.decryptFromStringToString(spom));
             }
           } catch(Rabin.RabinKeyException e){JOptionPane.showMessageDialog(null, e.getMessage(), "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
             catch(NumberFormatException  e1){JOptionPane.showMessageDialog(null, "Wartość klucza musi być podana w systemie szesnastkowym!", "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
    ...
    private void zapisz_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zapisz_kluczActionPerformed
      try{ 
          ...
          int wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".rabinSecKey";
                plikKluczaSec=new File(pom);
          ...
          wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".rabinPubKey";
                plikKluczaPub=new File(pom);
                jTextField7.setText(pom);
               try
