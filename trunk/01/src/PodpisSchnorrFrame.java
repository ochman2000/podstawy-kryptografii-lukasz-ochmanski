...
public class PodpisSchnorrFrame extends JInternalFrame implements InternalFrameListener
{
    ...
    class SchnorrSecFilter extends javax.swing.filechooser.FileFilter 
    {
        
        String ext;
        
        public SchnorrSecFilter ()
        {
            ext=".SchnorrSecKey";
        }
        ...
        {
            return "Plik klucza prywatnego algorytmu Schnorra";
        }
    }
    
    class SchnorrPubFilter extends javax.swing.filechooser.FileFilter 
    {
        
        String ext;
        
        public SchnorrPubFilter ()
        {
            ext=".SchnorrPubKey";
        }
        ...
        public String getDescription()
        {
            return "Plik klucza publicznego algorytmu Schnorra";
        }
    }
    ...
    public PodpisSchnorrFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) 
    {
       ...
       initComponents();
        jTextField3.setText(schnorr.q.toString(16)+" "+schnorr.h.toString(16));
        jTextField8.setText(schnorr.v.toString(16));
        jTextField9.setText(schnorr.a.toString(16));
        jTextField10.setText(schnorr.p.toString(16));
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Klucz Publiczny: v");
    ...
    private void wczytaj_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wczytaj_kluczActionPerformed
     try{
        ...
        fch.setFileFilter(new SchnorrSecFilter()); 
        int wybor =fch.showOpenDialog(this);
        if (wybor == JFileChooser.APPROVE_OPTION) 
        {   String pom=fch.getSelectedFile().getPath();
        ...
        fch.setFileFilter(new SchnorrPubFilter()); 
        ...
        {   String pom=fch.getSelectedFile().getPath();
            ...
            {  String tab[]=(new String(Auxx.wczytajZPliku(pom))).split("\n");   
                ...
                schnorr.q= new BigInteger(pom[0],16);
                schnorr.h= new BigInteger(pom[1],16);
                schnorr.v= new BigInteger(jTextField8.getText(),16);
                schnorr.a= new BigInteger(jTextField9.getText(),16);
                schnorr.p= new BigInteger(jTextField10.getText(),16);     
    ...
    private void zapisz_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zapisz_kluczActionPerformed
     try{ 
          ...
          int wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".SchnorrSecKey";
                plikKluczaSec=new File(pom);
          ...
          wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".SchnorrPubKey";
                plikKluczaPub=new File(pom);
                jTextField7.setText(pom);
               try
    ...
    private void podpisujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_podpisujActionPerformed
       ...
       * ustawiamy w klasie e,d,n*/
        try{
             ...
             if(jRadioButton1.isSelected())//plik
             {  if(tekstJawny!=null)podpis=schnorr.podpisuj(tekstJawny);
             ...
             { BigInteger podpis[]=schnorr.podpisuj(jTextArea1.getText());
           ...
           } catch(Schnorr.SchnorrKeyException e){JOptionPane.showMessageDialog(null, e.getMessage(), "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
             catch(NumberFormatException  e1){JOptionPane.showMessageDialog(null, "Wartość klucza musi być podana w systemie szesnastkowym!", "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
    ...
    private void weryfikujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weryfikujActionPerformed
        try{
            ...
            if(jRadioButton1.isSelected())//plik
             {if(schnorr.weryfikujBigInt(tekstJawny, podpis))
             ...
             {if(schnorr.weryfikujString(jTextArea1.getText(), jTextArea2.getText()))
                 JOptionPane.showMessageDialog(null, "Podpis jest zgodny.", "Weryfikacja się powiodła", JOptionPane.INFORMATION_MESSAGE ); 
              else   JOptionPane.showMessageDialog(null, "Podpis nie jest zgodny!!!", "Weryfikacja się nie powiodła!!!", JOptionPane.ERROR_MESSAGE);
