...
public class SlepyPodpisRSAFrame extends JInternalFrame implements InternalFrameListener
{
    ...
    public SlepyPodpisRSAFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) 
    {
       super(title, resizable, closable, maximizable, iconifiable);
        ...
        jTextField9.setText(rsa.k.toString(16));
        jTextField10.setText(rsa.N.toString(16));
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Klucz Prywatny: g");

        jLabel10.setText("Zaślepka k");
    ...
    {   String pom=fch.getSelectedFile().getPath();
        ...
        try
        {    podpis=new BigInteger(1,Auxx.hexToBytes(new String(Auxx.wczytajZPliku(pom))));  
            jTextArea2.setText(new String(Auxx.wczytajZPliku(pom)));
        }catch(Exception e){JOptionPane.showMessageDialog(null, "Problem z otworzeniem pliku"+pom, "Problem z otworzeniem pliku", JOptionPane.ERROR_MESSAGE); };
    ...
    try{
        ...
        {   String pom=fch.getSelectedFile().getPath();
            ...
            {  String tab[]=(new String(Auxx.wczytajZPliku(pom))).split("\n");   
                jTextField8.setText(tab[0]);
                jTextField9.setText(tab[1]);
        ...
        {   String pom=fch.getSelectedFile().getPath();
            ...
            {  String tab[]=(new String(Auxx.wczytajZPliku(pom))).split("\n");   
                ...
                rsa.k= new BigInteger(jTextField9.getText(),16);
                rsa.N= new BigInteger(jTextField10.getText(),16);
                reczna_edycja_klucza=false;
    ...
    {   String pom=fch.getSelectedFile().getPath();
        ...
        try{ if(jRadioButton1.isSelected())//plik
             Auxx.zapiszDoPliku(podpis.toString(16).getBytes() ,pom);
      ...
      try{ 
          ...
          int wybor =fch.showSaveDialog(this);
            ...
            {   String pom=fch.getSelectedFile().getPath();
               ...
               try
                { String spom=jTextField8.getText()+'\n'+jTextField9.getText()+'\n'+jTextField10.getText();
    ...
    private void weryfikujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weryfikujActionPerformed
         try{
            if(reczna_edycja_klucza)
            {
             ...
             {if(rsa.weryfikujBigIntSlepo(tekstJawny, podpis))
                 JOptionPane.showMessageDialog(null, "Podpis jest zgodny.", "Weryfikacja się powiodła", JOptionPane.INFORMATION_MESSAGE ); 
              else   JOptionPane.showMessageDialog(null, "Podpis nie jest zgodny!!!", "Weryfikacja się nie powiodła!!!", JOptionPane.ERROR_MESSAGE);
             }
             else  
             {if(rsa.weryfikujStringSlepo(jTextArea1.getText(), jTextArea2.getText()))
                 JOptionPane.showMessageDialog(null, "Podpis jest zgodny.", "Weryfikacja się powiodła", JOptionPane.INFORMATION_MESSAGE ); 
              else   JOptionPane.showMessageDialog(null, "Podpis nie jest zgodny!!!", "Weryfikacja się nie powiodła!!!", JOptionPane.ERROR_MESSAGE);
       ...
       * ustawiamy w klasie e,d,n*/
        try{
            if(reczna_edycja_klucza)
            {
             ...
             if(jRadioButton1.isSelected())//plik
             {  if(tekstJawny!=null)podpis=rsa.podpisujSlepo(tekstJawny);
                else throw new Exception("Wybierz plik zawierający tekst jawny!");
                String wynik=Auxx.bigIntToString(podpis);
                jTextArea2.setText(Auxx.bytesToHex(wynik.getBytes()));
             }
             else jTextArea2.setText(Auxx.bytesToHex(rsa.podpisujSlepo(jTextArea1.getText()).toByteArray())); 
