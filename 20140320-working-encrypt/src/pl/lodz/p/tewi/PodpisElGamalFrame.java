...
public class PodpisElGamalFrame extends JInternalFrame implements InternalFrameListener{
    ...
    public PodpisElGamalFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) 
    {
           ...
           if(reczna_edycja_klucza)
            {
             ...
             if(jRadioButton1.isSelected())//plik
             {  if(tekstJawny!=null)podpis=elgamal.podpisuj(tekstJawny);
             ...
             { BigInteger podpis[]=elgamal.podpisuj(jTextArea1.getText());
             ...
             catch(Exception e2){JOptionPane.showMessageDialog(null, e2.getMessage(), "Wybierz plik", JOptionPane.ERROR_MESSAGE);}//JOptionPane.showMessageDialog(null, e2.getMessage(), "Wybierz plik", JOptionPane.ERROR_MESSAGE); }
    ...
    private void weryfikujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weryfikujActionPerformed
         try{
            ...
            if(jRadioButton1.isSelected())//plik
             {if(elgamal.weryfikujBigInt(tekstJawny, podpis))
             ...
             {if(elgamal.weryfikujString(jTextArea1.getText(), jTextArea2.getText()))
                 JOptionPane.showMessageDialog(null, "Podpis jest zgodny.", "Weryfikacja się powiodła", JOptionPane.INFORMATION_MESSAGE ); 
              else   JOptionPane.showMessageDialog(null, "Podpis nie jest zgodny!!!", "Weryfikacja się nie powiodła!!!", JOptionPane.ERROR_MESSAGE);
