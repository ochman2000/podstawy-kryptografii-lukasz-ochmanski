...
public class PodpisRSAFrame extends JInternalFrame implements InternalFrameListener
{
    ...
    class PodpisRSASecFilter extends javax.swing.filechooser.FileFilter 
    {
        
        String ext;
        
        public PodpisRSASecFilter ()
        {
            ext=".rsaSecKey";
        }
     ...
     class PodpisRSAPubFilter extends javax.swing.filechooser.FileFilter 
     {
        
        String ext;
        
        public PodpisRSAPubFilter ()
        {
            ext=".rsaPubKey";
        }
    ...
    public PodpisRSAFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) {
    ...
    private void wczytaj_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wczytaj_kluczActionPerformed
     try{
        ...
        fch.setFileFilter(new PodpisRSASecFilter()); 
        int wybor =fch.showOpenDialog(this);
        if (wybor == JFileChooser.APPROVE_OPTION) 
        {   String pom=fch.getSelectedFile().getPath();
        ...
        fch.setFileFilter(new PodpisRSAPubFilter()); 
       ...
       * ustawiamy w klasie e,d,n*/
        try{
            if(reczna_edycja_klucza)
            {
             ...
             {  if(tekstJawny!=null)podpis=rsa.podpisuj(tekstJawny);
             ...
             else jTextArea2.setText(Auxx.bytesToHex(rsa.podpisuj(jTextArea1.getText()).toByteArray())); 
    ...
    private void weryfikujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_weryfikujActionPerformed
        try{
            if(reczna_edycja_klucza)
            {
             ...
             if(jRadioButton1.isSelected())//plik
             {if(rsa.weryfikujBigInt(tekstJawny, podpis))
             ...
             {if(rsa.weryfikujString(jTextArea1.getText(), jTextArea2.getText()))
                 JOptionPane.showMessageDialog(null, "Podpis jest zgodny.", "Weryfikacja się powiodła", JOptionPane.INFORMATION_MESSAGE ); 
              else   JOptionPane.showMessageDialog(null, "Podpis nie jest zgodny!!!", "Weryfikacja się nie powiodła!!!", JOptionPane.ERROR_MESSAGE);
