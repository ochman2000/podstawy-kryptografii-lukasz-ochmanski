...
public class PlecakowyFrame extends JInternalFrame implements InternalFrameListener
{
    private Plecakowy plecakowy=new Plecakowy();
    ...
    class PlecakowySecFilter extends javax.swing.filechooser.FileFilter 
    {
        
        String ext;
        
        public PlecakowySecFilter ()
        {
            ext=".knapSecKey";
        }
        ...
        {
            return "Plik klucza prywatnego algorytmu Plecakowego";
        }
    }
     class PlecakowyPubFilter extends javax.swing.filechooser.FileFilter 
     {
        
        String ext;
        
        public PlecakowyPubFilter ()
        {
            ext=".knapPubKey";
        }
        ...
        public String getDescription()
        {
            return "Plik klucza publicznego algorytmu Plecakowego";
        }
    }
    ...
    public PlecakowyFrame(String title, boolean resizable, boolean closable, boolean maximizable, boolean iconifiable) 
    {
       super(title, resizable, closable, maximizable, iconifiable);
        ...
        initComponents();
        jTextField3.setText(plecakowy.kluczPublicznyString);
        jTextField8.setText(plecakowy.kluczPrywatnyString);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Klucz Publiczny");
        ...
        jLabel9.setText("Klucz Prywatny");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTextField8, javax.swing.GroupLayout.PREFERRED_SIZE, 660, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(12, 12, 12)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel3, jLabel9});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jTextField3, jTextField8});
    ...
    private void szyfrujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_szyfrujActionPerformed
         try{
             ...
             {  if(tekstJawny!=null)szyfrogram=plecakowy.encrypt(tekstJawny);
             ...
             else jTextArea2.setText(Auxx.bytesToHex(plecakowy.encryptFromStringToString(jTextArea1.getText()).getBytes())); 
             
           } catch(Plecakowy.PlecakowyKeyException e){JOptionPane.showMessageDialog(null, e.getMessage(), "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
             ...
             catch(Exception e2){JOptionPane.showMessageDialog(null, e2.getMessage(), "Wybierz plik", JOptionPane.ERROR_MESSAGE); e2.printStackTrace();}
    ...
    private void wczytaj_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_wczytaj_kluczActionPerformed
     try{
        ...
        fch.setFileFilter(new PlecakowySecFilter()); 
        int wybor =fch.showOpenDialog(this);
        if (wybor == JFileChooser.APPROVE_OPTION) 
        {   String pom=fch.getSelectedFile().getPath();
            ...
            try
            {  jTextField8.setText(new String(Auxx.wczytajZPliku(pom)));
            }catch(Exception e){JOptionPane.showMessageDialog(null, "Problem z otworzeniem pliku"+pom, "Problem z otworzeniem pliku", JOptionPane.ERROR_MESSAGE); };
        }
        fch.setDialogTitle("Podaj nazwę pliku klucza publicznego");
        fch.setFileFilter(new PlecakowyPubFilter()); 
    ...
    private void deszyfrujActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deszyfrujActionPerformed
      try{
             ...
             if(jRadioButton1.isSelected())//plik
             {deszyfrogram=plecakowy.decrypt(szyfrogram);
              jTextArea1.setText(new String(deszyfrogram));
             }
             else  
             {String spom=new String(Auxx.hexToBytes(jTextArea2.getText()));
              jTextArea1.setText(plecakowy.decryptFromStringToString(spom));
             }
           } //catch(Plecakowy.PlecakowyKeyException e){JOptionPane.showMessageDialog(null, e.getMessage(), "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
             catch(NumberFormatException  e1){JOptionPane.showMessageDialog(null, "Wartość klucza musi być podana w systemie szesnastkowym!", "Problem z kluczem", JOptionPane.ERROR_MESSAGE); }
    ...
    private void zapisz_kluczActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zapisz_kluczActionPerformed
      try{ 
          ...
          int wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".knapSecKey";
                plikKluczaSec=new File(pom);
                jTextField7.setText(pom);
               try
                { Auxx.zapiszDoPliku(jTextField8.getText().getBytes(), pom);
                }catch(Exception e){JOptionPane.showMessageDialog(null, "Problem z otworzeniem pliku"+pom, "Problem z otworzeniem pliku", JOptionPane.ERROR_MESSAGE); };
            }
          fch.setDialogTitle("Podaj nazwę pliku klucza publicznego");
          fch.setFileFilter(new PlecakowyPubFilter());
          wybor =fch.showSaveDialog(this);
            if (wybor == JFileChooser.APPROVE_OPTION) 
            {   String pom=fch.getSelectedFile().getPath();
                if (pom.lastIndexOf('.')==-1)pom+=".knapPubKey";
                plikKluczaPub=new File(pom);
                jTextField7.setText(pom);
               try
